<template>
	<view>
		<divider></divider>
		<card headTitle="发票类型" bodyPadding>
		...
		<card headTitle="发票抬头" bodyPadding>
			<zcm-radio-group :label="label2" :selected.sync='label2.selected'></zcm-radio-group>
		</card>
		<divider></divider>
		
		<view class="p-2 d-flex a-center border-bottom border-light-secondary bg-white">
		...
		<view class="p-2 d-flex a-center bg-white">
			...
			<text class="font-md ml-2">123****1234</text>
		</view>
