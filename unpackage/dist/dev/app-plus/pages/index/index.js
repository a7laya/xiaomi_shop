    ...
    [
      ...
      _c(
        ...
        _vm._l(_vm.tabBars, function(item, index) {
          return _c("div", { key: index, staticClass: ["j-end", "a-center"] }, [
            _c("text", { staticClass: ["font-big"] }, [
...
var demoTabBar = [{ name: '关注', id: 'guanzhu', template: 'index' }, { name: '推荐', id: 'tuijian', template: 'special' },
{
  name: '体育',
  id: 'tiyu',
  template: 'special' },
...

{
  ...
  created: function created() {
    ...
    currentWebview.addEventListener('show', function (e) {
      console.log(__f__('首页显示', currentWebview.getURL(), " at pages\\index\\index.nvue:195"));
    });
  },
