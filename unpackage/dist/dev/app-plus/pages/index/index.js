    ...
    [
      ...
      _c(
        ...
        _vm._l(_vm.tabBars, function(item, index) {
          return _c("list", { key: index, attrs: { showScrollbar: "false" } }, [
            _c(
              "refresh",
              {
            ...
            _c(
              ...
              [
                ...
                _c("divider"),
                _c("sum-three-adv", { attrs: { resData: _vm.threeAdvs } }),
                _c("divider"),
...
var _sumTabbar = _interopRequireDefault(__webpack_require__(/*! @/components/index/nvue/sum-tabbar */ 53));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //
//
//
//
//
...
var currentWebview = plus.webview.currentWebview(); // 模拟后端数据
var demoTabBar = [{ name: '关注', id: 'guanzhu', template: 'index' }, { name: '推荐', id: 'tuijian', template: 'special' }, { name: '体育', id: 'tiyu', template: 'special' }, { name: '热点', id: 'redian', template: 'special' }, { name: '财经', id: 'caijing', template: 'special' }, { name: '娱乐', id: 'yule', template: 'special' }, { name: '军事', id: 'junshi', template: 'special' }, { name: '历史', id: 'lishi', template: 'special' }, { name: '本地', id: 'bendi', template: 'special' }];var _default = { components: { sumSlider: _sumSlider.default, sumIndexNavs: _sumIndexNavs.default,
  ...
  created: function created() {
    ...
    currentWebview.addEventListener('show', function (e) {
      console.log(__f__('首页显示', currentWebview.getURL(), " at pages\\index\\index.nvue:230"));
    });
  ...
  methods: {
    ...
    change: function () {var _change = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(index) {var _this = this;var el;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                dom.getComponentRect(el, function (e) {
                  console.log(__f__(e, " at components\\index\\nvue\\sum-tabbar.nvue:41"));
                  if (e.size.right > 730) {
