...

{
  ...
  created: function created() {
    ...
    currentWebview.addEventListener('show', function (e) {
      console.log(__f__('首页显示', currentWebview.getURL(), " at pages\\index\\index.nvue:150"));
    });
