...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'true'])
Z([3,'width:200rpx;border:1px solid red;'])
Z([3,'1'])
Z(z[1])
Z([3,'2'])
Z(z[1])
...
var z=gz$gwx_3()
var cF=_n('view')
var hG=_n('scroll-view')
_rz(z,hG,'scrollX',0,e,s,gg)
var oH=_n('view')
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:4998:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:4998:1)",{path:"./app.wxss"});    
